...
window.mjlRulesListInit = function () {
    ...
    function buildRow(rule, withAppear) {
        ...
        return '<div class="' + rowClass + '">'
            ...
            + '<span class="rule-target"><span class="badge bg-blue-lt text-blue">' + esc(rule.target) + '</span></span>'
            + '<span class="rule-event"><span class="badge bg-azure-lt text-azure">' + esc(rule.event) + '</span></span>'
